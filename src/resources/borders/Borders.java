...
public class Borders {
	...
	private static Border bTitleBorde = BorderFactory.createLineBorder( Colors.cuteBlue , 1);
	...
	public  static Border []  border = {
			...
			BorderFactory.createTitledBorder(bTitleBorde , "Listado Libros" , TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.ABOVE_TOP, Fonts.fontTitleBorder, Colors.cuteBlue),
 	};
}
